...
def main():
    mup_PT, mup_PHI, mup_ETA, mum_PT, mum_PHI, mum_ETA= read_muon_data(StoragePaths.ppdata2, "MCDecayTree;1")
    ...
    bin_avg_energy, Afb, err_invariant_mass, err_counts = measure_Afb_from_data(data, 13, (60, 120))
    ...
    plt.savefig(f"{StoragePaths.plots_path}/A_fb_measurement_ppdata2_with_errors_plot.png")
    plt.show()
