...
def main():
    data = read_muon_data(StoragePaths.real_data, "Z/DecayTree")
    invariant_mass = calc_invariant_mass(*data)
    create_histogram(invariant_mass, "real_invariant_mass_distribution_in_fudicial", (0.6e5, 1.20e5) , xy_text=(-20, 20))
