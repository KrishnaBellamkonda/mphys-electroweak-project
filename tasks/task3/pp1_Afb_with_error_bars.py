...
def main():
    mup_PT, mup_PHI, mup_ETA, mum_PT, mum_PHI, mum_ETA= read_muon_data(StoragePaths.ppdata1, "MCDecayTree;1")
    ...
    plt.savefig(f"{StoragePaths.plots_path}/A_fb_measurement_ppdata1_with_errors_plot.png")
    plt.show()
