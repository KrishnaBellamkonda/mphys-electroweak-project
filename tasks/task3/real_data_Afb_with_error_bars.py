...
def main():
    mup_PT, mup_PHI, mup_ETA, mum_PT, mum_PHI, mum_ETA= read_muon_data(StoragePaths.real_data, "Z/DecayTree")
    ...
    plt.savefig(f"{StoragePaths.plots_path}/Afb_real_data.png")
    plt.show()
