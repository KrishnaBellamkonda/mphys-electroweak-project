...
def main():
    ...
    # Step 4) Create two psuedomass distributions
    ...
    # Step 5) Plot and weight pos psuedo mass
    ...
    ax.hist(pos_psuedomass, density=False, range=(0.7e5, 1.1e5), bins=n_bins, label="Pos Psuedomass", fc=(1,0,0,0.5))
    ...
    ax.hist(neg_psuedomass, density=False, range=(0.7e5, 1.1e5), bins=n_bins, label="Neg Psuedomass", fc=(0,0,1,0.5))
    ax.set_ylabel("Counts")
    ax.set_xlabel("Mass")
    ax.set_title("Distribution of the Invariant Mass in Muon Deacy")
    #ax.annotate(
