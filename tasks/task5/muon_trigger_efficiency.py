...
def main():
    ...
    mup_eff,mup_bins = calc_trigger_eff(mup_ETA,n_bins,True,posFlags,negFlags)
    mum_eff,mum_bins = calc_trigger_eff(mum_ETA,n_bins,False,posFlags,negFlags)
    ...
    plt.scatter(mup_bin_centres,mup_eff,marker="^",c="b",s=4,label="mu+")
    plt.scatter(mum_bin_centres,mum_eff,marker="v",c="r",s=4,label="mu-")
    plt.xlabel("eta")
...
#    ax.set_ylabel("Counts")
    ...
    plt.legend()
    plt.savefig(f"{StoragePaths.plots_path}/triggerEfficiency.png")
